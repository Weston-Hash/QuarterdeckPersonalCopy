  ...
  var INIT_FITREBS = [
    {
      ...
      currentStage: 1,
      stages: [
        _demoStage("Submitted", null, "\u{1F4DD}", "Locklin", "2026-03-01", ""),
        _demoStage("PC Review", "plt_cdr", "\u{1F464}", null, null, ""),
        _demoStage("Co CDR Review", "co_cdr", "\u2B50", null, null, ""),
        _demoStage("ADJ Review", "adj", "\u{1F5C2}", null, null, ""),
        _demoStage("BNXO Review", "xo", "\u{1F396}", null, null, ""),
        _demoStage("BNCO Approval", "bn_cdr", "\u2705", null, null, ""),
        _demoStage("Complete", null, "\u{1F3C5}", null, null, "")
      ]
    },
    {
      id: "FIT-002",
      subjectId: "u044",
      subjectName: "Madulara",
      subjectRank: "MIDN 4/C",
      company: "Bravo",
      platoon: "1st PC",
      period: "Spring 2026",
      ...
      currentStage: 2,
      stages: [
        _demoStage("Submitted", null, "\u{1F4DD}", "Madulara", "2026-03-02", ""),
        _demoStage("PC Review", "plt_cdr", "\u{1F464}", "Alcazar", "2026-03-05", "Strong performer. Shows initiative in platoon activities."),
        _demoStage("Co CDR Review", "co_cdr", "\u2B50", null, null, ""),
        _demoStage("ADJ Review", "adj", "\u{1F5C2}", null, null, ""),
        _demoStage("BNXO Review", "xo", "\u{1F396}", null, null, ""),
        _demoStage("BNCO Approval", "bn_cdr", "\u2705", null, null, ""),
    ...
    },
    {
      ...
      currentStage: 3,
      stages: [
        _demoStage("Submitted", null, "\u{1F4DD}", "Crimmins", "2026-03-01", ""),
        _demoStage("PC Review", "plt_cdr", "\u{1F464}", "Burrell", "2026-03-04", "Excellent leadership potential. Consistently performs above expectations."),
