...
const CSS = `
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .topbar-logo { width: 40px; height: 40px; background: #BF5700; border-radius: 6px; display: flex; align-items: center; justify-content: center; font-size: 1.6rem; line-height: 1; color: white; margin-right: 0.7rem; }
  ...
  .login-mark { width: 56px; height: 56px; background: #BF5700; border-radius: 10px; display: flex; align-items: center; justify-content: center; font-size: 2.2rem; line-height: 1; color: white; }
